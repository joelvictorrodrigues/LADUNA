// Mock data for LADUNA Digital Marketing Agency
...
export const blogPosts = [
  {
    ...
    excerpt: "Descubra as principais tendências e estratégias que estão moldando o futuro do marketing digital e como aplicá-las no seu negócio.",
  ...
  {
    id: 2,
    title: "Google Ads vs Meta Ads: Qual é Melhor para Seu Negócio?",
    excerpt: "Análise completa das duas principais plataformas de tráfego pago, com dicas para escolher a melhor estratégia para seus objetivos.",
  ...
  {
    id: 3,
    title: "SEO em 2024: Guia Completo para Dominar o Google",
    excerpt: "Estratégias avançadas de SEO que realmente funcionam. Aprenda como otimizar seu site para os algoritmos mais recentes do Google.",
